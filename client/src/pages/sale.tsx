...
export default function SalePage() {
  ...
  // Filter for featured products (using as sale items)
  ...
  return (
    <div className="py-8 sm:py-12" data-testid="sale-page">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Page Header */}
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-light text-brand-red mb-2" data-testid="sale-title">
            Sale Items
          </h1>
          <p className="text-sm sm:text-base text-medium-gray" data-testid="sale-subtitle">
        ...
        {filteredProducts.length === 0 && (
          <div className="text-center py-12" data-testid="no-products-message">
            <p className="text-medium-gray text-lg">No sale items available at the moment.</p>
          </div>
        )}
      </div>
